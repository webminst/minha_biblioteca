  ...
  return (
    <div className="about-container">
      ...
      <section className="about-section">
        ...
        <p>Foi no início de 1985, quando iniciei o curso técnico em Mecânica (ETESG Machado de Assis) que conheci o Henrique. Henrique era um homem casado, por volta de 35 anos, que na época trabalhava na Engesa, uma pessoa formidável. Rapidamente nos tornamos colegas de escola. Ele frequentava a Igreja Presbiteriana do Brasil em Caçapava, e frequentemente fazia convites para que eu visitasse sua igreja. Confesso que na época achava que “os crentes” eram todos “um bando de subversivos” que queria acabar com a Igreja Católica. Não gostava deles. Mas a amizade com Henrique, dia após dia, ia me revelando uma pessoa diferente. Seus constantes e insistentes convites foram, como diz o ditado diz, “água mole em pedra dura”.</p>
        <p>Certa vez, ele me convidou para ir ao aniversário da Igreja. Na ocasião, viria um pastor de fora (Rev. Miguel Ângelo) e seria um final de semana festivo. Pensei comigo, vou aproveitar a ocasião, visitar a igreja dele e “pagar essa dívida”, depois poderei recusar convites futuros com mais propriedade.</p>
        ...
        <p>Com Abilene compartilhei minhas mazelas, meus sonhos, alegrias e frustrações. Confesso que, em alguns momentos, cheguei a pensar que ela não suportaria. Hoje, já compartilhamos vinte e oito anos de casamento e temos um casal de filhos, a Giulia e o Arthur.</p>
        ...
        <p>Vale ressaltar o apoio e a participação do Rev. Anselmo e Aldenisa, sua esposa, na minha vida. O pastor Anselmo sempre foi um referencial de vida e ministério para mim. Moura Jr., foi fundamental nesse processo. Quantas e quantas vezes não fui à sua casa para tirar dúvidas e ser aconselhado por ele. Serei eternamente grato por sua influência em minha vida.</p>
      </section>

      <section className="about-section">
        <h2>Chamado para o Ministério</h2>
        <p>Acredito que meu chamado efetivo para o ministério tenha ocorrido numa programação de aniversário da então congregação do Planalto, hoje Igreja Presbiteriana do Planalto, em Mossoró. Lembro-me que na ocasião o pregador, depois de expor o texto de Isaías 6, fez um apelo e no meu íntimo, impactado pela mensagem, respondi também: “Envia-me a mim”. Depois desse episódio passei a considerar o ministério e compartilhei isso com meu pastor e com Abilene. Entretanto, sentia que precisava conhecer mais a Palavra de Deus e a doutrina da Igreja para servir melhor a Deus e sua Igreja. Foram três longos anos como aspirante ao sagrado ministério até poder ser aprovado pelo Conselho da Igreja e pelo Presbitério para ser enviado ao Seminário Presbiteriano do Norte, em Recife-PE, em fevereiro de 1997.</p>
