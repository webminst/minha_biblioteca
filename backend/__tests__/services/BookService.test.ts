...
describe('BookService', () => {
    describe('findAll', () => {
        ...
        it('deve retornar um objeto paginado mesmo sem filtros', async () => {
            const mockBooks: MockBook[] = [{ title: 'Livro 1' }, { title: 'Livro 2' }];
            ...
            (Book.find as jest.Mock).mockImplementation(() => ({ sort: mockSort, skip: mockSkip, limit: mockLimit, select: mockSelect }));
