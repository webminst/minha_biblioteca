    ...
    try {
        ...
        for (let i = 1; i <= 12; i++) {
            try {
                ...
                const response = await axios_1.default.post(`${BASE_URL}/api/test/simulate-login`, testData, {
                    timeout: 10000,
                    validateStatus: () => true
                });
                ...
                if (response.status === 429) {
                    ...
                    const statusResponse = await axios_1.default.get(`${BASE_URL}/api/test/check-attempts?ip=203.0.113.1`, {
                        validateStatus: () => true
                    });
