            ...
            <div className="setup-container">
                ...
                {step === 1 && (
                    <div className="setup-step">
                        ...
                        <p className="step-description">
                            ...
                            à sua conta. Você precisará de um aplicativo autenticador instalado no seu dispositivo móvel.
                        </p>
                ...
                {step === 2 && (
                    <div className="setup-step">
                        ...
                        <p className="step-description">
                            Abra seu app autenticador e escaneie o código QR abaixo,
                        ...
                        <div className="qr-section">
                            {setupData.qrCode && (
                                <div className="qr-code-container">
                                    <img src={setupData.qrCode} alt="QR Code 2FA" className="qr-code" />
                                </div>
                            )}
                    ...
                    <div className="setup-step">
                        ...
                        <div className="backup-codes-section">
                            ...
                            <p className="backup-description">
                                <strong>Guarde estes códigos em local seguro!</strong> Eles podem ser usados
                                para acessar sua conta se você perder o dispositivo móvel.
                            </p>
                        ...
                        <div className="setup-actions">
                            <button onClick={completeSetup} className="btn btn-primary btn-large">
