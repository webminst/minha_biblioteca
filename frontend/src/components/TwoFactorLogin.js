    ...
    <div className='two-factor-login'>
      <div className='login-container'>
            ...
            {!useBackupCode ? (
              <div className='totp-section'>
                <div className='instruction'>
                  <p>
                    <strong>Digite o código de 6 dígitos</strong> do seu
                    aplicativo autenticador
                  </p>
              ...
              <div className='backup-section'>
                <div className='instruction'>
                  <p>
                    <strong>Digite um dos códigos de backup</strong> que você
                    salvou durante a configuração
                  </p>
          ...
          <details className='help-details'>
            ...
            <div className='help-content'>
              <div className='help-item'>
                ...
                <p>
                  Use um dos códigos de backup que você salvou durante a
                  configuração.
                </p>
              </div>
              <div className='help-item'>
                ...
                <p>
                  Entre em contato com o administrador do sistema para redefinir
              ...
              <div className='help-item'>
                ...
                <p>
                  Verifique se o relógio do seu dispositivo está sincronizado.
                  Os códigos TOTP são sensíveis ao tempo.
                </p>
              </div>
            </div>
          </details>
        ...
        <div className='security-notice'>
          ...
          <p>
            Sua conta está protegida por autenticação de dois fatores. Nunca
