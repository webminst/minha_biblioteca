...
const TwoFactorManagement = () => {
    ...
    const handleDisable2FA = async () => {
        try {
            ...
            setError(error.response?.data?.message || 'Erro ao desabilitar autenticação de dois fatores');
        } finally {
    ...
    const handleRegenerateBackupCodes = async () => {
        try {
            ...
            setError(error.response?.data?.message || 'Erro ao gerar novos códigos de backup');
        } finally {
            setActionLoading(false);
        }
    };
                        ...
                        <div className="status-card">
                            <div className="status-header">
                                ...
                                <div className="status-info">
                                    <h3>Status Atual</h3>
                                    <p className={`status-badge ${status.enabled ? 'enabled' : 'disabled'}`}>
                            ...
                            {status.enabled && (
                                <div className="status-details">
                                    ...
                                    {status.backupCodesRemaining !== undefined && (
                                        <div className="detail-item">
                                            <span className="detail-label">Códigos de backup restantes:</span>
                                            <span className={`detail-value ${status.backupCodesRemaining <= 2 ? 'warning' : ''}`}>
                    ...
                    <div className="actions-section">
                        <div className="action-card">
                            ...
                            {status.backupCodesRemaining <= 2 && (
                                <div className="warning-notice">
                                    ...
                                    <span>Poucos códigos de backup restantes! Recomendamos gerar novos códigos.</span>
                                </div>
                            )}
                        ...
                        <div className="action-card danger">
                            <div className="action-header">
                                ...
                                <p>Desabilitar a autenticação de dois fatores reduzirá a segurança da sua conta</p>
                            </div>
                    ...
                    <div className="modal-overlay">
                        <div className="modal confirm-modal">
                            ...
                            <div className="modal-body">
                                <p>
                                    <strong>Tem certeza que deseja desabilitar a autenticação de dois fatores?</strong>
                                </p>
                                <p>
                                ...
                                <div className="warning-box">
                                    ...
                                    <span>Todos os códigos de backup atuais serão invalidados</span>
                                </div>
                            </div>
