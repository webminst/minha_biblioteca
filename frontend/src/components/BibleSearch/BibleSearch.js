...
import { fetchVerse, validateReference, fetchRandomVerse, AVAILABLE_TRANSLATIONS } from '../../services/bibleApiService';
    ...
    const handleSearch = async (reference = searchTerm) => {
        ...
        try {
            ...
            if (isValid) {
                ...
                alert('Referência bíblica não encontrada. Verifique a formatação e tente novamente.');
            }
        } catch (error) {
    ...
    return (
        <div className="bible-search">
            <div className="search-header">
                ...
                <p>Digite uma referência bíblica (ex: João 3:16, Salmos 23, Mateus 5:1-10)</p>
            </div>
            ...
            <div className="usage-tips">
                <h3>💡 Dicas de Uso</h3>
                <ul>
                    <li><strong>Versículo único:</strong> João 3:16</li>
                    <li><strong>Capítulo inteiro:</strong> Salmos 23</li>
                    <li><strong>Intervalo de versículos:</strong> Mateus 5:1-10</li>
                    <li><strong>Versículos específicos:</strong> Romanos 8:28,31</li>
