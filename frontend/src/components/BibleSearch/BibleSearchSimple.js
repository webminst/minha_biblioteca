  ...
  return (
    <div className='bible-search'>
      <div className='search-header'>
        <h2>Busca Bíblica</h2>
        <p>
          Busque versículos por referência usando a Bíblia Revista e Atualizada
        </p>
      </div>
      ...
      {verse && verse.isError && (
        <div className='error-message'>⚠️ {verse.text}</div>
      )}
      ...
      <div className='search-info'>
        ...
        <ul>
          <li>
            <strong>Versículos específicos:</strong> João 3:16, Salmos 23:1
          </li>
          <li>
            <strong>Múltiplos versículos:</strong> Romanos 8:28-29
          </li>
          <li>
            <strong>Capítulos:</strong> Salmos 23
          </li>
          <li>
