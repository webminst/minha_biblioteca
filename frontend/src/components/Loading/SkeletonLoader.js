...
export const SkeletonText = ({ lines = 3, className = '' }) => (
    <div className={className}>
        {Array.from({ length: lines }, (_, index) => (
            <div
                key={index}
                className={`skeleton skeleton-text ${index === 0 ? 'title' :
                        index === lines - 1 ? 'short' : 'line'
                    }`}
            />
        ))}
    </div>
...
export const SkeletonContentCard = () => (
    <div className="skeleton-content-card">
        <div className="skeleton-header">
            ...
            <div className="skeleton skeleton-button" style={{ width: '80px', height: '30px' }} />
        </div>
        ...
        <div className="skeleton-footer">
            ...
            <div className="skeleton skeleton-button" style={{ width: '100px', height: '35px' }} />
        </div>
    </div>
);
        ...
        {Array.from({ length: items }, (_, index) => (
            <div key={index} className="skeleton-admin-item">
                <div className="skeleton-info">
                    <div className="skeleton skeleton-text title" style={{ width: '70%' }} />
...
export const SkeletonForm = () => (
    <div className="skeleton-form">
        <div className="skeleton skeleton-text title" style={{ width: '40%', marginBottom: '2rem' }} />

        {Array.from({ length: 4 }, (_, index) => (
            <div key={index} style={{ marginBottom: '1.5rem' }}>
                <div className="skeleton skeleton-text" style={{ width: '20%', height: '16px', marginBottom: '0.5rem' }} />
        ...
        <div style={{ display: 'flex', gap: '1rem', marginTop: '2rem' }}>
            ...
            <div className="skeleton skeleton-button" style={{ width: '100px', height: '40px' }} />
        </div>
    </div>
);
...
export const SkeletonDetail = () => (
    <div className="skeleton-detail">
        {/* Botão voltar */}
        <div className="skeleton skeleton-button" style={{ width: '80px', height: '35px', marginBottom: '2rem' }} />

        {/* Título */}
        <div className="skeleton skeleton-text title" style={{ width: '80%', marginBottom: '1rem' }} />

        {/* Subtitle */}
        <div className="skeleton skeleton-text subtitle" style={{ width: '60%', marginBottom: '2rem' }} />
        ...
        {/* Botões de ação */}
        <div style={{ display: 'flex', gap: '1rem', marginTop: '2rem' }}>
            <div className="skeleton skeleton-button" style={{ width: '140px', height: '40px' }} />
            <div className="skeleton skeleton-button" style={{ width: '120px', height: '40px' }} />
        </div>
    </div>
);
