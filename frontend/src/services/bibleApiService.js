...
const BOOK_MAPPING_PT = {
    ...
    '1reis': '1rs', '1 reis': '1rs', '1rs': '1rs',
    '2reis': '2rs', '2 reis': '2rs', '2rs': '2rs',
    ...
    'cantares': 'ct', 'cantico': 'ct', 'ct': 'ct',
    'isaias': 'is', 'isaías': 'is', 'is': 'is',
    'jeremias': 'jr', 'jr': 'jr',
    'lamentacoes': 'lm', 'lamentações': 'lm', 'lm': 'lm',
    'ezequiel': 'ez', 'ez': 'ez',
    'daniel': 'dn', 'dn': 'dn',
    'oseias': 'os', 'oséias': 'os', 'os': 'os',
    'joel': 'jl', 'jl': 'jl',
    ...
    'atos': 'at', 'at': 'at',
    'romanos': 'rm', 'rm': 'rm',
    '1corintios': '1co', '1 coríntios': '1co', '1co': '1co',
    '2corintios': '2co', '2 coríntios': '2co', '2co': '2co',
    'galatas': 'gl', 'gálatas': 'gl', 'gl': 'gl',
    'efesios': 'ef', 'efésios': 'ef', 'ef': 'ef',
    'filipenses': 'fp', 'fp': 'fp',
    ...
    '1joao': '1jo', '1 joão': '1jo', '1jo': '1jo',
    '2joao': '2jo', '2 joão': '2jo', '2jo': '2jo',
    '3joao': '3jo', '3 joão': '3jo', '3jo': '3jo',
    'judas': 'jd', 'jd': 'jd',
    'apocalipse': 'ap', 'ap': 'ap'
};
 ...
 */
const fetchVerseBrazilianAPI = async (book, chapter, verse, version = 'ara') => {
    try {
 ...
 */
export const fetchRandomVerse = async (translation = 'ara', testament = null) => {
    try {
        // Lista de versículos populares para seleção aleatória
        const popularVerses = [
            'João 3:16', 'Salmos 23:1', 'Filipenses 4:13', 'Jeremias 29:11',
            'Romanos 8:28', 'Provérbios 3:5-6', 'Isaías 40:31', 'Mateus 28:19-20',
            'Efésios 2:8-9', '1 João 4:19', 'Josué 1:9', 'Salmos 46:1',
            'Mateus 11:28-30', 'Romanos 10:9', '2 Timóteo 3:16', 'Hebreus 11:1'
        ];
 ...
 */
export const fetchMultipleVerses = async (references, translation = 'almeida') => {
