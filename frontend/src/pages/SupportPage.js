  ...
  return (
    <div className='support-container'>
      ...
      <h1>
        <FontAwesomeIcon
          icon={faHeart}
          style={{ marginRight: '10px', color: 'var(--color-green-ipb)' }}
        />
      ...
      <div className='support-intro'>
        <p>
          Se o conteúdo compartilhado neste espaço tem sido uma bênção para sua
          vida e você deseja contribuir para a manutenção e expansão deste
          ministério de ensino, sua generosidade é muito bem-vinda.
        </p>
        <p>
          As contribuições ajudam a cobrir os custos de hospedagem do site,
          aquisição de novos livros para estudo e resumo, ferramentas para
          produção de conteúdo e, eventualmente, a dedicação de mais tempo para
          criar e compartilhar recursos que edifiquem o corpo de Cristo.
        </p>
        <p>Sua semente plantada aqui frutificará no avanço do Evangelho!</p>
      </div>
      ...
      <div className='pix-donation-section'>
        ...
        <p>
          Você pode fazer sua contribuição de forma rápida e segura utilizando a
          chave PIX abaixo:
        </p>
        ...
        <div className='pix-details'>
          <p>
            <strong>Titular:</strong> {accountHolderName}
          </p>
          <p>
            <strong>Instituição:</strong> {bankName}
          </p>
        </div>
      ...
      <div className='alternative-support'>
        ...
        <p>
          Além de contribuições financeiras, você também pode apoiar este
          ministério:
        </p>
        <ul>
          <li>
            Orando por este trabalho e por aqueles que são alcançados por ele.
          </li>
          <li>
            Compartilhando os sermões, estudos e recursos com amigos e
            familiares.
          </li>
